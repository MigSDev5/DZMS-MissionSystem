...
_endMission = {
    ...
    DZMSInProgress = DZMSInProgress - ["EM3"];
...
_group1 = [_coords,6,1] call DZMSAISpawn;
_group2 = [_coords,6,1] call DZMSAISpawn;
_group3 = [_coords,4,1] call DZMSAISpawn;
...
_status = [position _boxFin,_DZMSUnitsMajor,30] call DZMSWaitMissionComp;
