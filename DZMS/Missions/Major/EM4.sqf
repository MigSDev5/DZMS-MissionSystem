...
private ["_missName","_coords","_base1","_base2","_base3","_base4","_base5","_base6","_base7","_base8","_base9","_base10","_base11","_base12","_base13","_base14","_base15","_base16","_base17","_veh1","_vehicle","_crate","_marker","_markerA","_markerB","_group1","_group2","_group3","_group4","_endMission","_status","_DZMSUnitsMajor"];
...
DZMSInProgress set [count DZMSInProgress,"EM4"];
...
_endMission = {
    ...
    DZMSInProgress = DZMSInProgress - ["EM4"];
};

//DZMSAISpawn spawns AI to the mission.
//Usage: [_coords, count, skillLevel, unitArray]
_group1 = [[(_coords select 0) - 0.5635,(_coords select 1) + 0.3173,0],3,1] call DZMSAISpawn;
_group2 = [[(_coords select 0) - 0.5635,(_coords select 1) + 0.3173,0],3,1] call DZMSAISpawn;
_group3 = [[(_coords select 0) - 0.5635,(_coords select 1) + 0.3173,0],3,1] call DZMSAISpawn;
_group4 = [[(_coords select 0) - 0.5635,(_coords select 1) + 0.3173,0],3,1] call DZMSAISpawn;
