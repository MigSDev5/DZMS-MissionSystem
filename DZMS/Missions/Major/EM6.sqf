...
private ["_missName","_coords","_crash","_body","_body1","_body2","_body3","_veh1","_vehicle","_vehicle1","_crate","_crate2","_marker","_markerA","_markerB","_group1","_group2","_group3","_status","_endMission","_DZMSUnitsMajor"];
...
DZMSInProgress set [count DZMSInProgress,"EM6"];
...
_endMission = {
    ...
    DZMSInProgress = DZMSInProgress - ["EM6"];
};

//DZMSAISpawn spawns AI to the mission.
//Usage: [_coords, count, skillLevel, unitArray]
_group1 = [[(_coords select 0) - 6.9458,(_coords select 1) - 3.5352, 0],6,1] call DZMSAISpawn;
_group2 = [[(_coords select 0) + 4.4614,(_coords select 1) + 2.5898, 0],6,1] call DZMSAISpawn;
_group3 = [[(_coords select 0) + 4.4614,(_coords select 1) + 2.5898, 0],4,1] call DZMSAISpawn;

_DZMSUnitsMajor = _group1 + _group2 + _group3;
